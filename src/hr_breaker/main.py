...
FILTER_INFO = {
    ...
    "HallucinationChecker": {
        ...
        "advice": "Добавьте в инструкции: *«Не добавляйте ничего чего нет в оригинале, только перефразируйте»*. Перед отправкой обязательно проверьте PDF.",
    },
    "KeywordMatcher": {
        "name": "Ключевые слова",
